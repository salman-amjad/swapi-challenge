...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/providers-choice-challenge
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/providers-choice-challenge_test
```
